...
/// Tracks a simple on-device "N free downloads per day" counter.
///
...
class DownloadQuota extends ChangeNotifier {
  ...
  int get remainingFreeDownloads {
    if (!_isToday(_countDate)) return freeDownloadsPerDay;
    return (freeDownloadsPerDay - _count).clamp(0, freeDownloadsPerDay);
  }
  ...
  Future<File> _file() async {
    ...
    return File('${dir.path}/download_quota.json');
  }
